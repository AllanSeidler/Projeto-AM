...
def matriz_confusao_media(model, X, y, kf):
    ...
    print("+-------------------------+")
    print("| não mentiu |   mentiu   |")
    print("+-------------------------+")
    print(f"| {avg_confusion_matrix[0][0]:10.1f} | {avg_confusion_matrix[0][1]:10.1f} |")
    print(f"| {avg_confusion_matrix[1][0]:10.1f} | {avg_confusion_matrix[1][1]:10.1f} |")
    print("+-------------------------+")
...
if __name__=='__main__':    
    arquivo = pd.read_csv('csv/mentiu.csv')
    y = arquivo['mentiu']
